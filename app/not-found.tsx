...
export default function NotFound() {
    ...
    <div className="h-screen bg-neutral-950 relative flex flex-col items-center justify-center antialiased">
      <div className="max-w-2xl mx-auto p-4">
        <h1 className="relative z-10 text-lg md:text-7xl  bg-clip-text text-transparent bg-gradient-to-b text-neutral-100 to-neutral-600  text-center font-sans font-bold">
            In progress
        </h1>
        <p></p>
